...
//     "house":     ["house_high", ...],         prizes always listed first, under that heading
...
//   }
//
// `npm run setup` writes this file by asking questions. It can also be written by hand.
//
...
const list = (v) => (Array.isArray(v) ? v.map(String) : v === 'all' ? 'all' : []);
